...
const StampSheet = ({ isOpen, onOpenChange, selectedInvoice }) => {
  console.log("StampSheet - selectedInvoice:", selectedInvoice); // Add this line for debugging
      ...
      <SheetContent side="right" className="w-[45vw] min-w-[50vw] overflow-visible" onPointerDownOutside={(e) => e.preventDefault()}>
        <div className="p-4 h-full overflow-visible">
          ...
          <div className="h-[calc(100%-2rem)] overflow-visible">
            <StampForm selectedInvoice={selectedInvoice} />
          </div>
        </div>
      </SheetContent>
    </Sheet>
