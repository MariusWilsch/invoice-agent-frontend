...
export const useUpdateLifeCycleDone = () => {
    const queryClient = useQueryClient();
    return useMutation({
        mutationFn: (updatedItem) => fromSupabase(supabase.from('life_cycle_done').update(updatedItem).eq('call_uuid', updatedItem.call_uuid)),
        onSuccess: () => {
            queryClient.invalidateQueries('life_cycle_done');
        },
    });
...
export const useUpdateAircallSummary = () => {
    const queryClient = useQueryClient();
    return useMutation({
        mutationFn: (updatedItem) => fromSupabase(supabase.from('aircall_summary').update(updatedItem).eq('call_uuid', updatedItem.call_uuid)),
        onSuccess: () => {
            queryClient.invalidateQueries('aircall_summary');
        },
    });
...
export const useUpdateInvoicesDev = () => {
    const queryClient = useQueryClient();
    return useMutation({
        mutationFn: (updatedItem) => fromSupabase(supabase.from('invoices_dev').update(updatedItem).eq('id', updatedItem.id)),
        onSuccess: () => {
            queryClient.invalidateQueries('invoices_dev');
        },
    });
...
export const useUpdateCallUserAccess = () => {
    const queryClient = useQueryClient();
    return useMutation({
        mutationFn: (updatedItem) => fromSupabase(supabase.from('call_user_access').update(updatedItem).eq('id', updatedItem.id)),
        onSuccess: () => {
            queryClient.invalidateQueries('call_user_access');
        },
    });
...
export const useUpdateAircallSummaryDev = () => {
    const queryClient = useQueryClient();
    return useMutation({
        mutationFn: (updatedItem) => fromSupabase(supabase.from('aircall_summary_dev').update(updatedItem).eq('call_uuid', updatedItem.call_uuid)),
        onSuccess: () => {
            queryClient.invalidateQueries('aircall_summary_dev');
        },
    });
...
export const useUpdateDropdownOptionInvoicesDev = () => {
    const queryClient = useQueryClient();
    return useMutation({
        mutationFn: (updatedItem) => fromSupabase(supabase.from('dropdown_options_invoices_dev').update(updatedItem).eq('id', updatedItem.id)),
        onSuccess: () => {
            queryClient.invalidateQueries('dropdown_options_invoices_dev');
        },
    });
...
export const useUpdateAircallUserMapping = () => {
    const queryClient = useQueryClient();
    return useMutation({
        mutationFn: (updatedItem) => fromSupabase(supabase.from('aircall_user_mappings').update(updatedItem).eq('uuid', updatedItem.uuid)),
        onSuccess: () => {
            queryClient.invalidateQueries('aircall_user_mappings');
        },
    });
